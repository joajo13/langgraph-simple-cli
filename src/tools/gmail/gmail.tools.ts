...
function wrapGmailTool(tool: StructuredTool, newName: string, description: string, customSchema?: any) {
...
export const createGmailTools = (authService: AuthService): StructuredTool[] => {
